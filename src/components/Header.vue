    ...
    <header id="header">
        ...
        <div class="header-container">
            ...
            <nav class="header-nav">
                ...
                <ul>
                    <li><router-link to="/" title="Home">avin.here()</router-link></li>
                    <li><a href="mailto:hello@avinhere.me" title="Send me an email">.contact()</a></li>
                    ...
                    <li class="social-link">
                        <a href="https://github.com/avincodes" target="_blank" title="GitHub">
