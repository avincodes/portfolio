(function() {
    ...
    function initHeader() {
        ...
        largeHeader = document.getElementById('background-content');
        largeHeader.style.height = height+'px';

        canvas = document.getElementById('background-content');
        canvas.width = width;
    ...
    function Triangle() {
        ...
        function init() {
            ...
            _this.coords[0].x = -60+Math.random()*100;
            _this.coords[0].y = -60+Math.random()*100;
            _this.coords[1].x = -60+Math.random()*100;
            _this.coords[1].y = -60+Math.random()*100;
            _this.coords[2].x = -60+Math.random()*100;
            _this.coords[2].y = -60+Math.random()*100;
